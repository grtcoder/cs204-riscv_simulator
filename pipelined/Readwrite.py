...
def mem_read_write(machine_code, aluVals,ins_type,mem_read,mem_write,mem_qty,PC):
    # print("PC: {}".format(PC))
    aluVal=[]
    ...
    if(ins_type=="I" and mem_read==1):
        ...
        print("start: {}".format(start))
        temp=write_from_memory(start,mem_qty,-1)
        # reg[0]=[0 for i in range(32)]
...
def reg_write(machine_code, aluVals,ins_type,mem_read,mem_write,mem_qty,PC,reg_id,w_val):
    # print("PC: {}".format(PC))
    # aluVal=[]
    # print("alu: {}".format(aluVals))
    # for _ in aluVals:
